                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <ul>
                            ...
                            <li>
                                <h4 className="ff-jose my-1 text-red">Senior Software Engineer</h4>
                                <h6 className="blue-label px-2 py-1">August 2021 - May 2023</h6>
                            ...
                            <li>
                                ...
                                <p className="m-0">Space Applications Centre (ISRO)</p>
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <h1>
                            ...
                            <a href="https://www.linkedin.com/in/pulkit007/" target="/blank" className="text-white text-decoration-none mx-2">
